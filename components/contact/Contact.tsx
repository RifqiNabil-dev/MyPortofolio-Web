        ...
        <div className="relative h-screen w-full">
          <div className="flex h-screen w-full ">
            <Canvas
              ...
              style={{ backgroundColor: "transparent", height: "900px"}}
            >
        ...
        <div className="contact-content relative flex min-h-[100svh] w-full flex-col items-center justify-between pt-12">
          ...
          <div className="flex w-full justify-between py-12">
            <div>
              ...
              <Link
                href="https://github.com/RifqiNabil-dev"
                target="_blank"
            ...
            <div className="flex flex-col items-end">
              ...
              <div className="flex items-center gap-x-2">
                <ContactLink
                  href="https://www.instagram.com/n4bil_alfath/"
                  label="Instagram"
                  icon={
                ...
                />
                <ContactLink
                  href="mailto:alfathnabil26@gmail.com"
                  label="Email"
                  icon={
